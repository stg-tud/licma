...
if __name__ == '__main__':
    ...
    print("PyNaCl -> rule3 -> p_example1_hard_coded1:",
          decrypt(g_key, testRule3c.p_example1_hard_coded1(g_plaintext)[24:]) == g_plaintext)
    print("PyNaCl -> rule3 -> p_example2_hard_coded2:",
          decrypt(g_key, testRule3c.p_example2_hard_coded2(g_plaintext)[24:]) == g_plaintext)
    print("PyNaCl -> rule3 -> p_example3_local_variable1:",
          decrypt(g_key, testRule3c.p_example3_local_variable1(g_plaintext)[24:]) == g_plaintext)
    print("PyNaCl -> rule3 -> p_example4_local_variable2:",
          decrypt(g_key, testRule3c.p_example4_local_variable2(g_plaintext)[24:]) == g_plaintext)
    print("PyNaCl -> rule3 -> p_example5_nested_local_variable1:",
          decrypt(g_key, testRule3c.p_example5_nested_local_variable1(g_plaintext)[24:]) == g_plaintext)
    print("PyNaCl -> rule3 -> p_example6_nested_local_variable2:",
          decrypt(g_key, testRule3c.p_example6_nested_local_variable2(g_plaintext)[24:]) == g_plaintext)
    print("PyNaCl -> rule3 -> p_example7_direct_method_call1:",
          decrypt(g_key, testRule3c.p_example7_direct_method_call1(g_plaintext)[24:]) == g_plaintext)
    print("PyNaCl -> rule3 -> p_example8_direct_method_call2:",
          decrypt(g_key, testRule3c.p_example8_direct_method_call2(g_plaintext)[24:]) == g_plaintext)
    print("PyNaCl -> rule3 -> p_example9_nested_method_call1:",
          decrypt(g_key, testRule3c.p_example9_nested_method_call1(g_plaintext)[24:]) == g_plaintext)
    print("PyNaCl -> rule3 -> p_example10_nested_method_call2:",
          decrypt(g_key, testRule3c.p_example10_nested_method_call2(g_plaintext)[24:]) == g_plaintext)
    print("PyNaCl -> rule3 -> p_example11_direct_g_variable_access1:",
          decrypt(g_key, testRule3c.p_example11_direct_g_variable_access1(g_plaintext)[24:]) == g_plaintext)
    print("PyNaCl -> rule3 -> p_example12_direct_g_variable_access2:",
          decrypt(g_key, testRule3c.p_example12_direct_g_variable_access2(g_plaintext)[24:]) == g_plaintext)
    print("PyNaCl -> rule3 -> p_example13_indirect_g_variable_access1:",
          decrypt(g_key, testRule3c.p_example13_indirect_g_variable_access1(g_plaintext)[24:]) == g_plaintext)
    print("PyNaCl -> rule3 -> p_example14_indirect_g_variable_access2:",
          decrypt(g_key, testRule3c.p_example14_indirect_g_variable_access2(g_plaintext)[24:]) == g_plaintext)
    print("PyNaCl -> rule3 -> p_example15_warning_parameter_not_resolvable:", decrypt(g_key,
                                                                                      testRule3c.p_example15_warning_parameter_not_resolvable(
                                                                                          g_key, g_plaintext)[
                                                                                      24:]) == g_plaintext)
    print("PyNaCl -> rule3 -> n_example1_random_key:", testRule3c.n_example1_random_key(g_plaintext))

    # TestRule4c code
    testRule4c = TestRule4c()
    print("PyNaCl -> rule4 -> p_example1_hard_coded1:",
          decrypt(get_pbk(g_salt), testRule4c.p_example1_hard_coded1(g_password, g_plaintext)[24:]) == g_plaintext)
    print("PyNaCl -> rule4 -> p_example2_hard_coded2:",
          decrypt(get_pbk(g_salt), testRule4c.p_example2_hard_coded2(g_password, g_plaintext)[24:]) == g_plaintext)
    print("PyNaCl -> rule4 -> p_example3_local_variable1:",
          decrypt(get_pbk(g_salt), testRule4c.p_example3_local_variable1(g_password, g_plaintext)[24:]) == g_plaintext)
    print("PyNaCl -> rule4 -> p_example4_local_variable2:",
          decrypt(get_pbk(g_salt), testRule4c.p_example4_local_variable2(g_password, g_plaintext)[24:]) == g_plaintext)
    print("PyNaCl -> rule4 -> p_example5_nested_local_variable1:", decrypt(get_pbk(g_salt),
                                                                           testRule4c.p_example5_nested_local_variable1(
                                                                               g_password, g_plaintext)[
                                                                           24:]) == g_plaintext)
    print("PyNaCl -> rule4 -> p_example6_nested_local_variable2:", decrypt(get_pbk(g_salt),
                                                                           testRule4c.p_example6_nested_local_variable2(
                                                                               g_password, g_plaintext)[
                                                                           24:]) == g_plaintext)
    ...
    print("PyNaCl -> rule4 -> p_example11_direct_g_variable_access1:", decrypt(get_pbk(g_salt),
                                                                               testRule4c.p_example11_direct_g_variable_access1(
                                                                                   g_password, g_plaintext)[
                                                                               24:]) == g_plaintext)
    print("PyNaCl -> rule4 -> p_example12_direct_g_variable_access2:", decrypt(get_pbk(g_salt),
                                                                               testRule4c.p_example12_direct_g_variable_access2(
                                                                                   g_password, g_plaintext)[
                                                                               24:]) == g_plaintext)
    print("PyNaCl -> rule4 -> p_example13_indirect_g_variable_access1:", decrypt(get_pbk(g_salt),
                                                                                 testRule4c.p_example13_indirect_g_variable_access1(
                                                                                     g_password, g_plaintext)[
                                                                                 24:]) == g_plaintext)
    print("PyNaCl -> rule4 -> p_example14_indirect_g_variable_access2:", decrypt(get_pbk(g_salt),
                                                                                 testRule4c.p_example14_indirect_g_variable_access2(
                                                                                     g_password, g_plaintext)[
                                                                                 24:]) == g_plaintext)
    print("PyNaCl -> rule4 -> p_example15_warning_parameter_not_resolvable:", decrypt(get_pbk(g_salt),
                                                                                      testRule4c.p_example15_warning_parameter_not_resolvable(
                                                                                          g_password, g_salt,
                                                                                          g_plaintext)[
                                                                                      24:]) == g_plaintext)
    print("PyNaCl -> rule4 -> n_example1_random_salt:", testRule4c.n_example1_random_salt(g_password, g_plaintext))
